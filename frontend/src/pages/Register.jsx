...
import { FaPencilAlt, FaRegUser,  FaAddressBook } from "react-icons/fa";
          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="wrapper">
              ...
              <div className="inputTag">
                ...
                <div>
                  <input type="number" placeholder="111-222-3333" value={phone} onChange={(e) => setPhone(e.target.value)} />
                  <FaPhoneFlip />
                </div>
              </div>
            </div>
